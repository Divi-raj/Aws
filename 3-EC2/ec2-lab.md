...
![EC2 Instance Dashboard](/assets/.labImages/ec2InstanceDashboard.png)
**Step 3:** In the launch wizard, fill in the details as indicated.
![EC2 Instance Launch Wizard](/assets/.labImages/ec2InstanceLaunchWizard.png)
...
![EC2 Instance Launch Wizard](/assets/.labImages/ec2IntanceLaunchWizard2.png)
...
![EC2 Instance Created](/assets/.labImages/ec2InstanceCreated.png)
...
![EC2 Instance SSH](/assets/.labImages/ec2InstanceSSH.png)
...
![Volume Creation Dashboard](/assets/.labImages/volumesDashboard.png)

![Snapshot Creation Wizard](/assets/.labImages/snapshotCreation.png)
...
![Snapshot Creation Dashboard](/assets/.labImages/snapshotCreated.png)
...
![Volume Creation Dashboard](/assets/.labImages/volumeCreationDashboard.png)
...
![Volume From Snapshot](/assets/.labImages/volumeFromSnapshot.png)
...
![Volume Attachment](/assets/.labImages/volumeAttachWizard.png)
...
![Mount Volume](/assets/.labImages/mountAVolume.png)
...
![AMI Creation Dashboard](/assets/.labImages/AMICreationDashboard.png)
...
![AMI Creation Wizard](/assets/.labImages/AMICreationWizard.png)

**Step 3:** Once the AMI is created this will be available to use as a base image to create new EC2 Instance.

![AMI Creation Wizard](/assets/.labImages/AMICreated.png)
...
![EC2 Instance From AMI](/assets/.labImages/EC2UsingMyAMI.png)

**Step 5:** SSH in to the newly created EC2 instance and verify if working. 

![SSH into EC2 Instance](/assets/.labImages/SSHIntoEC2CreatedonAMI.png)

**Step 6:** Optionally deregister the AMI if not planning to use. 

![EC2 Instance From AMI](/assets/.labImages/deregisterAMI.png)
